...
<div id="d" class="container-fluid">
	...
	<tbody>
    	...
    	<tr>
      	...
      	<td>${dto.sSCORE}</td>
      	<td>${dto.sSALLOWED_PERSONNEL}</td>
      	<td><button style="width:60px; height:25px; font-size:0.8rem; line-height:10px" type="button" class="btn btn-primary" onclick="location.href=encodeURI('OpeningSubjectSignUp?OPENING_SUBJECT_ID=${dto.sOPENING_SUBJECT_ID}&SUBJECT_ID=${dto.sSUBJECT_ID}&SUBJECT_NAME=${dto.sSUBJECT_NAME}&PROFESSOR_NAME=${dto.sPROFESSOR_NAME}&LECTURE_TIME=${dto.sLECTURE_TIME}&LECTURE_ROOM=${dto.sLECTURE_ROOM}&SCORE=${dto.sSCORE}')">신청</button></td>
      	</tr>
		</c:forEach>
	</tbody>
