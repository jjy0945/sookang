...
<div id="d" class="container-fluid">
	...
	<tbody>
    	...
    	<tr>
      	...
      	<td><c:if test="${dto.sPROFESSOR_ID == Id}"><button style="width:60px; height:25px; font-size:0.8rem; line-height:10px" type="submit" class="btn btn-primary" onclick="location.href='OpeningSubjectDelete?OPENING_SUBJECT_ID=${dto.sOPENING_SUBJECT_ID}'">취소</button></c:if></td>
      	</tr>
		</c:forEach>
	</tbody>
